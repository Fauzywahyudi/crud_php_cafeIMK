...
<head>
	...
	<style type="text/css" media="screen">
      ...
      <!-- body{
        background-image: url(../member/gambar/background_utama.jpg);
      }.style1 {color: #FF0000}
-->
    </style>
...
<div class="content">
	...
	<div class="menu">
		<ul>
			...
			<li><a href="index.php?page=tambah"><b>Tambah</b></a></li>
			<li><a href="index.php?page=editdata"><b>EDIT DATA</b></a></li>
